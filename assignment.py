...
#The break statement is used inside loops (like for or while) to exit the loop immediately, skipping any remaining code in the loop.
...
# #The continue statement is also used inside loops but instead of exiting the loop, it skips the rest of the code inside the loop for the current iteration and moves on to the next iteration.
# for i in range(5):
#     if i == 2:
#         continue
#     print(i)
